...
# ECR Repository
resource "aws_ecr_repository" "logging_system" {
  name                 = "${local.name_prefix}-logging-system"
...
resource "aws_ecr_lifecycle_policy" "logging_system" {
  repository = aws_ecr_repository.logging_system.name
...
resource "aws_cloudwatch_log_group" "monitoring" {
  name              = "/aws/ecs/${local.name_prefix}/monitoring"
  retention_in_days = var.log_retention_days
...
resource "aws_ecs_task_definition" "app" {
  ...
  container_definitions = jsonencode([
    {
      name  = "logging-system"
      image = "${aws_ecr_repository.logging_system.repository_url}:latest"
